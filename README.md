...
**Please add 'sync_bn' at the end of the training script to reproduce the result in the article**


```
export CUDA_VISIBLE_DEVICES=0,1,2,3 bash ./tools/scripts/dist_train.sh 4 --sync_bn
```
## Abstract
...
| -- | -- | -- |
| VoD | [hgsfusion_vod.yaml](tools/cfgs/hgsfusion/hgsfusion_vod.yaml) | [Google](https://drive.google.com/drive/folders/1MbhSQxSakAl0bHmWoPSoNfxiAqtNv0RR?usp=sharing) [Baidu](https://pan.baidu.com/s/1_Ngbc-uobUiNlmF2OW1Vxw?pwd=2tdi) |
| TJ4D | [hgsfusion_tj4d.yaml](tools/cfgs/hgsfusion/hgsfusion_tj4d.yaml) | [Google](https://drive.google.com/drive/folders/1MbhSQxSakAl0bHmWoPSoNfxiAqtNv0RR?usp=sharing) [Baidu](https://pan.baidu.com/s/1_Ngbc-uobUiNlmF2OW1Vxw?pwd=2tdi) |
...
```
2. You can download the hybrid radar points from [Google](https://drive.google.com/drive/folders/1MbhSQxSakAl0bHmWoPSoNfxiAqtNv0RR?usp=sharing) or [Baidu](https://pan.baidu.com/s/1_Ngbc-uobUiNlmF2OW1Vxw?pwd=2tdi) and unzip them to the dataset folder.
